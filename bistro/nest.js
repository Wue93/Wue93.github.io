const MENU = [
  ...
  { id: 'movie', name: '沙发电影时间', category: '一起看', icon: '🎬', tagline: '选一部片子，把接下来的时间交给沙发。', people: '2–6人', time: '90–120分钟', type: '电影', difficulty: '放空即可', mood: 'relaxed', prep: '电视、投影或电脑，以及可用片源', how: '从今日片单中随机抽取一部电影。开始前准备好饮料和零食，中途尽量不再纠结换片。', special: true },
  { id: 'funny-variety', name: '搞笑综艺', category: '一起看', icon: '🤣', tagline: '今天不研究人生，只负责笑出声音。', people: '2–6人', time: '30–90分钟', type: '综艺、喜剧', difficulty: '放空即可', mood: 'lively', prep: '电视或投影，以及一集备选节目', how: '从收藏的搞笑综艺里挑一集或几个经典片段。谁先笑出声，谁负责拿下一轮零食。', special: true },
  { id: 'friends', name: '老友记', category: '一起看', icon: '☕', tagline: '去中央公园咖啡馆，和六位老朋友坐一会儿。', people: '2–6人', time: '25–50分钟', type: '情景喜剧', difficulty: '放空即可', mood: 'relaxed', prep: '电视或投影，以及可用片源', how: '随机选择一到两集《老友记》，或者每个人提名一集最喜欢的故事后投票决定。', special: true },
  { id: 'cyber-exhibition', name: '赛博看展', category: '一起看', icon: '🖼️', tagline: '不用出门，也可以在展厅里慢慢走一圈。', people: '2–6人', time: '30–60分钟', type: '线上展览、艺术', difficulty: '轻松', mood: 'relaxed', prep: '电脑或电视，以及线上展览页面', how: '打开一场线上展览或博物馆数字展厅，轮流决定下一件作品，并分享最想带回家的一件。', special: true },
  { id: 'luyu-talk', name: '鲁豫漫谈', category: '一起看', icon: '🎙️', tagline: '坐下来，听一场足够长、也足够松弛的谈话。', people: '2–6人', time: '45–90分钟', type: '访谈、漫谈', difficulty: '轻松', mood: 'relaxed', prep: '电视或投影，以及一期备选节目', how: '选择一期感兴趣的鲁豫访谈或漫谈节目。看完以后，每个人说一个最有共鸣或最想反驳的观点。', special: true },
  { id: 'cyber-concert', name: '赛博演唱会', category: '一起看', icon: '🎤', tagline: '客厅灯光调暗，这里临时变成第一排。', people: '2–6人', time: '60–120分钟', type: '演唱会、音乐现场', difficulty: '放空即可', mood: 'lively', prep: '电视或投影、音箱和演唱会片源', how: '选择一场完整演唱会或现场合集，调好灯光和音量。允许跟唱，也允许安静地坐完整场。', special: true },
  ...
  { id: 'book-blind-bag', name: '拆开一本书的命运', category: '隐藏款', icon: '📚', tagline: '看不到书名，只凭一句模糊提示挑走一本书。', people: '1–6人', time: '10–20分钟', mood: 'relaxed', prep: '包装好的书籍、推荐卡和借阅说明', how: '从只有提示语的盲袋中选一个，现场拆开并读出推荐卡。根据袋内说明决定带走或下次归还。', special: true, hidden: true },
...
const CATEGORIES = ['全部', '一起玩', '一起看', '吃点', '喝点', '隐藏款'];
const STORAGE = {
